...
import { DRTScoreView } from "@/components/drt-score-view"

export default function DRTScorePage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <DRTScoreView district={selectedDistrict} analysisMonth={analysisMonth} />
    </div>
  )
}
